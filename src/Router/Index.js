    ...
    <NavigationContainer>
      <Provider store={store}>
        <HomeStack.Navigator>
          ...
          <HomeStack.Screen name="PanggilanScreen" component={PanggilanScreen} options={{  title: "Panggilan Pelanggan", headerTintColor: Putih, headerStyle:{backgroundColor: Ijo}    }}/>
